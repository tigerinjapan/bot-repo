...
def get_today_news_image(forecast: str, today_outfit: str, msg: str) -> str:
    ...
    contents = (
        "480px X 360pxのサイズに合わせて、イメージを生成。"
        "イメージには、日本語、中国語、記号など英語以外の文字は、一切表示しない。"
        "ニュース番組の大きいモニター画面がある。"
        "その画面は、真っ白で、空白で、何も表示されていない。"
        "その画面は、イメージの中央に位置し、テレビスタンドがない。"
        "モニター画面とイメージ全体のサイズは、同じ。"
        "その画面は、イメージ全体サイズの9割を占める。"
        "番組名は、「Today's News」、画面の左上に表示する。英語の番組名だけ、表示。"
        f"イメージのの背景は、{forecast}が分かるようにする。"
        "その背景は、暗い色や複雑なイメージは避ける。"
