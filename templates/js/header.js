...
const APP_SITE = "site";
const APP_CAFE = "cafe";
const LIST_APP = [APP_TODAY, APP_NEWS, APP_KOREA, APP_RANKING, APP_LCC, APP_TV, APP_STUDY, APP_SITE, APP_CAFE];
...
const MENU_CAFE = "おしゃれカフェ";
const LIST_MENU = [MENU_TODAY, MENU_NEWS, MENU_KOREA, MENU_RANKING, MENU_LCC, MENU_TV, MENU_STUDY, MENU_SITE, MENU_CAFE];
const LIST_MENU_NOT_GUEST = [MENU_NEWS, MENU_STUDY, MENU_CAFE];
